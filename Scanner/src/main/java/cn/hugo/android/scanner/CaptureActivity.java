...
public final class CaptureActivity extends Activity implements
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case REQUEST_CODE:
                    ...
                    final Uri originalUri = intent.getData();        //获得图片的uri
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (result != null) {
                                ...
                                data.putExtra("result", ResultParser.parseResult(result).toString());
                                setResult(DECODE_OK,data);
                                finish();
                            } else {
    ...
    public static final int DECODE_OK = 124;
    /**
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        ...
        intent.putExtra("result", ResultParser.parseResult(rawResult).toString());
        setResult(DECODE_OK, intent);
        finish();
