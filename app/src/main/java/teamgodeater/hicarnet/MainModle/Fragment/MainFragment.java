...
public class MainFragment extends BaseFragment
     ...
     * 改变地图控制器位置 适应当前屏幕
     */
    private void requestMapControlPosition() {
        int left = bottomViewPager.getLeft();
        int top = bottomViewPager.getTop();
        int right = bottomViewPager.getRight();
        MapView m = mapHelp.mainMapView;
        Point scaleControlPoint = new Point(left, top - m.getScaleControlViewHeight() - Utils.dp2Px(6));
        Point ZoomControlsPoint = new Point(right - Utils.dp2Px(40), top / 2);
