...
public abstract class OldBaseFragment extends Fragment {
    ...
    //rootView
    public ViewGroup rootContain;
    //toolbarView
    public ViewGroup toolbarContain;
    ...
    public void destroySelf(long delay) {
        OldBaseFragmentManage.destroyTop(delay);
    }
    ...
    public void hideSelf(long delay) {
        ...
        h.postDelayed(new Runnable() {
            @Override
            public void run() {
                getFragmentManager().beginTransaction().hide(OldBaseFragment.this).commitAllowingStateLoss();
            }
        }, delay);
    }
