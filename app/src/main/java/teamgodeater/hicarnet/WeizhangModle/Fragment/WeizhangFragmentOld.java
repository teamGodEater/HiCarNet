...
public class WeizhangFragmentOld extends OldBaseFragment {
    ...
    public static WeizhangFragmentOld getInstans() {
        List<Fragment> fragments = ManageActivity.manageActivity.getSupportFragmentManager().getFragments();
        for (Fragment f : fragments) {
            if (f instanceof WeizhangFragmentOld) {
                return (WeizhangFragmentOld) f;
            }
        }
        return new WeizhangFragmentOld();
    }
    ...
    private void query() {
        ...
        if (weizhang.getStatus() == 2000 || weizhang.getStatus() == 2001) {
            WeiZhangDetialFragmentOld to = new WeiZhangDetialFragmentOld();
    ...
    private void setListener() {
        ...
        cityChose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CitySelectFragmentOld citySelectFragment = new CitySelectFragmentOld();
                citySelectFragment.setOnGetCityIdListener(new CitySelectFragmentOld.OnGetCityIdListener() {
                    @Override
