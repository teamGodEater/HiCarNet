...
import teamgodeater.hicarnet.RegistModle.Fragment.RegistFragmentOld;
...
public class LoginFragmentOld extends OldBaseFragment {
    @Bind(R.id.brandLogo)
    ...
    private void setListener() {
        ...
        regist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideSelf(500);
                manageActivity.switchFragment(new RegistFragmentOld());
            }
        });
