...
public class OrderFragmentOld extends OldBaseFragment {
    @Bind(R.id.tpi)
    ...
    public static OrderFragmentOld getInstans() {
        List<Fragment> fragments = ManageActivity.manageActivity.getSupportFragmentManager().getFragments();
        for (Fragment f : fragments) {
            if (f instanceof OrderFragmentOld) {
                return (OrderFragmentOld) f;
            }
        }
        return new OrderFragmentOld();
    }
